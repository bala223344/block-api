...
def eth_data(address,symbol,Preferred_Safename,Email,type_id):
    print("asdafasfasfa")
    ...
    print("9000000000000000000000000000000000000000000000000")
...
'''
def eth_data(address,symbol,type_id,Email,Preferred_Safename):
