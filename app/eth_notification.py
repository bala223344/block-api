...
from app.config import SendGridAPIClient_key,Sendgrid_default_mail,host,user,password,database,auth_plugin,ETH_transactions
        ...
        if send_amount != 0:
            ...
            if email_id is not None:
                ...
                message = Mail(
                        ...
                        to_emails="rasealex0000000@gmail.com",
