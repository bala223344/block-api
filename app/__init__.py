...
#---------register api files in blueprint----------
    ...
    EthSync_scheduler.add_job(EthSync, trigger='cron', day_of_week='mon-sun', hour=15,minute=14)
    EthSync_scheduler.add_job(EthSync,trigger='interval',minutes=28)
    EthSync_scheduler.add_job(EthSync,trigger='interval',minutes=32)
    ...
    EthIntSync_scheduler.add_job(EthIntSync3,trigger='interval',minutes=4)
