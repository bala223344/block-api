...
#---------register api files in blueprint----------
    ...
    EthSync_scheduler.add_job(EthSync, trigger='cron', day_of_week='mon-sun', hour=7,minute=52)
    ...
    btc_data_sync_scheduler.add_job(btc_data_sync, trigger='cron', day_of_week='mon-sat', hour=7,minute=50)
