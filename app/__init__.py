...
#--------Schedulers timing and days functionality------------
    ...
    tx_notification_scheduler.add_job(tx_notification, trigger='cron', day_of_week='mon-sat', hour=13, minute=30)
    #tx_notification_scheduler.add_job(tx_notification, trigger='interval', minutes=5)
