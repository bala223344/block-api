...
def balance():
    ...
    if type_id == "3":
        balance = ZRX_balance(address,cointype,type_id)
        return balance
    ...
    if type_id == "101":
        balance = GPL_balance(address,cointype,type_id)
        return balance
    
    if type_id == "102":
        balance = MATIC_balance(address,cointype,type_id)
        return balance
